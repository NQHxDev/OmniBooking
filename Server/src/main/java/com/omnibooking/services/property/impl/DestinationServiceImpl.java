    ...
    private String translateDestination(String name, String locale) {
       if ("en".equalsIgnoreCase(locale)) {
          switch (name) {
             ...
             case "Hồ Chí Minh": return "Ho Chi Minh City";
             case "Đà Nẵng": return "Da Nang";
             case "Hội An": return "Hoi An";
             case "Phú Quốc": return "Phu Quoc";
             case "Quảng Ninh": return "Quang Ninh";
             case "Hạ Long": return "Ha Long";
             case "Nha Trang": return "Nha Trang";
             case "Đà Lạt": return "Da Lat";
             case "Vũng Tàu": return "Vung Tau";
             case "Sapa": return "Sapa";
             case "Huế": return "Hue";
             case "Hải Phòng": return "Hai Phong";
             case "Cần Thơ": return "Can Tho";
             default: return name;
          }
       }
       return name;
    ...
    private String translateCountry(String countryName, String locale) {
       if ("en".equalsIgnoreCase(locale)) {
          ...
          switch (countryName) {
             ...
             case "United Kingdom": return "Vương quốc Anh";
             case "Japan": return "Nhật Bản";
             case "United States": return "Hoa Kỳ";
             case "Thailand": return "Thái Lan";
             default: return countryName;
          }
       }
       return countryName;
