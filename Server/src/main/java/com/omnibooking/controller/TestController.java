...
public class TestController {
   ...
   public ApiResponse<String> reindexProperties() {
      // Explicitly recreate properties index to apply settings.json and
      // vi_analyzer mapping
      ...
      // Sync properties from PostgreSQL to Elasticsearch
